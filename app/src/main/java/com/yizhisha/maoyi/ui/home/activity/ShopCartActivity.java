...
public class ShopCartActivity extends BaseActivity<ShoppCartPresenter> implements ShoppCartContract.View, SwipeRefreshLayout.OnRefreshListener {
    @Bind(R.id.toolbar)
    BaseToolbar mToobar;
    ...
    private void initAdapter(){
        ...
        adapter= new ShoppCartAdapter(this, parentMapList, childMapList_list);
    ...
    public void Dialog(SingleShoppGoodBean goodBean){
        goods_nmb=1;
        dialog = new CustomDialog(this,R.style.Dialog);//设置dialog的样式
        ...
        dialog_confirm_ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mLoadingDialog=new LoadingDialog(ShopCartActivity.this,"正在修改购物车...",false);
                mLoadingDialog.show();
                StringBuilder str=new StringBuilder();
